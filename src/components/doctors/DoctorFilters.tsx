...
export default function DoctorFilters({
  ...
  return (
    <div className="glass-card rounded-2xl p-6 border border-white/60 mb-8 space-y-6">
          ...
          <button
            ...
            className={
              ...
              (!filters.specialization
                ...
                : "bg-white/80 text-slate-700 hover:bg-secondary-50 border border-slate-200")
            }
          >
            All Specialties
          </button>
