...
export default function BookingModal({ doctor, isOpen, onClose }: BookingModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-md animate-fadeIn">
      <div className="glass-modal rounded-3xl p-6 sm:p-8 max-w-2xl w-full max-h-[92vh] overflow-y-auto relative shadow-2xl">
        <button
          onClick={handleClose}
        ...
        {!confirmedBooking ? (
          <div>
            <div className="mb-6">
              <span className="text-xs font-bold uppercase tracking-wider text-secondary-700 bg-secondary-100 px-3 py-1 rounded-full border border-secondary-200 inline-block mb-2">
                Instant Appointment
              </span>
          ...
          <div className="text-center py-6 space-y-6">
            ...
            <div>
              <span className="text-xs font-semibold text-secondary-700 uppercase tracking-widest bg-secondary-50 px-3 py-1 rounded-full border border-secondary-200">
                Booking Confirmed
              </span>
            ...
            <div className="bg-slate-50/80 p-5 rounded-2xl border border-slate-200 text-left space-y-3 text-sm">
              <div className="flex justify-between items-center pb-3 border-b border-slate-200">
                <span className="text-slate-500 text-xs font-medium">Doctor</span>
