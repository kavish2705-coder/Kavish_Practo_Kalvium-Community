...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = "default", size = "default", asChild = false, ...props }, ref) => {
    ...
    const variants = {
      ...
      outline: "border border-slate-200 bg-white/80 hover:bg-secondary-50 hover:border-secondary-300 text-slate-800",
      ghost: "hover:bg-secondary-100/60 hover:text-secondary-800 text-slate-700",
