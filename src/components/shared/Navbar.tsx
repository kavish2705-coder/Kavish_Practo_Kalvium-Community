    ...
    <header className="fixed top-0 z-50 w-full bg-white/20 backdrop-blur-md border-b border-white/30">
      <div className="container mx-auto px-4 md:px-6 h-16 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2 drop-shadow-sm">
          ...
          <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-teal-500 to-blue-500 flex items-center justify-center text-white font-bold text-lg shadow-md">
            P
          </div>
        ...
        <nav className="hidden md:flex gap-6 items-center text-sm font-semibold text-slate-800">
          <Link href="/doctors" className="hover:text-teal-700 transition-colors drop-shadow-sm">
            Find Doctors
          </Link>
          <Link href="/specialties" className="hover:text-teal-700 transition-colors drop-shadow-sm">
            Specialties
          </Link>
          <Link href="/about" className="hover:text-teal-700 transition-colors drop-shadow-sm">
            About Us
          </Link>
        </nav>
        ...
        <div className="flex items-center gap-4">
          ...
          <Button className="font-bold shadow-lg shadow-teal-500/30">Book Appointment</Button>
        </div>
      </div>
    </header>
  );
