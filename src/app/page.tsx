...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative min-h-[90vh] flex items-center">
        ...
        <div
          ...
          style={{
            ...
            WebkitMaskImage:
              "linear-gradient(to right, transparent 20%, black 60%)",
          }}
        />
          ...
          <div className="flex justify-end">
            <div className="max-w-2xl text-right animate-slow-slide-in-right">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-slate-900 mb-6 leading-tight">
                Expert Healthcare,
                <br />
                <span className="text-secondary-600">Just a Click Away.</span>
              </h1>
              <p className="text-lg text-slate-700 mb-8 max-w-xl ml-auto leading-relaxed">
                Find the best doctors, view their real-time availability, and
                book your appointment instantly. No waiting, no double-bookings,
                just seamless care.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-end">
                <Button
                  size="lg"
                  asChild
                  className="h-12 px-8 text-base shadow-lg shadow-secondary-500/20 bg-secondary-600 hover:bg-secondary-700 text-white border-0"
                >
                  <Link href="/doctors">
      ...
      <section
        id="specialties"
        className="py-16 bg-white border-b border-slate-200/60"
      >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
            {MOCK_SPECIALTIES.map((spec) => (
              <Link
                key={spec.id}
                href={
                  "/doctors?specialization=" + encodeURIComponent(spec.name)
                }
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-10 gap-4">
            ...
            <Button
              variant="outline"
              asChild
              className="self-start sm:self-auto text-xs border-slate-300 bg-white text-slate-700 hover:bg-slate-50"
            >
              <Link href="/doctors">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-slate-400 text-base">
              Book your doctor appointment in 3 simple steps. No hassle, just
              care.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 relative">
            ...
            <div className="relative p-8 rounded-3xl bg-white/5 backdrop-blur-xl border border-white/10 text-center shadow-2xl hover:-translate-y-2 hover:shadow-secondary-500/20 hover:border-secondary-500/50 transition-all duration-500 group overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-sm text-slate-400 leading-relaxed">
                  Filter by specialty, location, experience, or consultation
                  fee.
                </p>
              </div>
            </div>
            ...
            <div className="relative p-8 rounded-3xl bg-white/5 backdrop-blur-xl border border-white/10 text-center shadow-2xl hover:-translate-y-2 hover:shadow-secondary-500/20 hover:border-secondary-500/50 transition-all duration-500 group overflow-hidden md:translate-y-4">
              ...
              <div className="relative z-10">
                ...
                <p className="text-sm text-slate-400 leading-relaxed">
                  Pick a date and real-time available time slot that suits your
                  schedule.
                </p>
              </div>
            </div>
            ...
            <div className="relative p-8 rounded-3xl bg-white/5 backdrop-blur-xl border border-white/10 text-center shadow-2xl hover:-translate-y-2 hover:shadow-secondary-500/20 hover:border-secondary-500/50 transition-all duration-500 group overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-sm text-slate-400 leading-relaxed">
                  Receive immediate booking reference details with zero
                  double-bookings.
                </p>
              </div>
            </div>
      ...
      <footer className="bg-slate-900 py-10 border-t border-slate-800 text-center text-slate-200 text-xs">
        <div className="container mx-auto px-4 md:px-6">
          <p>
            © {new Date().getFullYear()} Practo. All rights reserved. Built for
            Sprint 1.
          </p>
        </div>
      </footer>
